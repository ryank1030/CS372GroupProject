...
<head>
    ...
    <meta name="google-signin-client_id" content="523585929304-ttd91os828i3dot84j72ak6qrf7k3596.apps.googleusercontent.com">
...
<body class="landing-body">
    ...
    <script>
        function onSignIn(googleUser) {
          ...
          window.location = "userSignIn.php?ID=" + profile.getId() + "&GivenName=" + profile.getGivenName() + "&FamilyName=" + profile.getFamilyName() + "&Image=" + profile.getImageUrl() + "&Email=" + profile.getEmail();
