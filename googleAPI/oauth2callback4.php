...
$client->setRedirectUri('http://' . $_SERVER['HTTP_HOST'] . '/oauth2callback3.php');  //set redirect url
...
if (! isset($_GET['code'])) {  //if we don't have the code yet
  ...
  $redirect_uri = 'http://' . $_SERVER['HTTP_HOST'] . '/signin-deleteEvent.php';  //redirect var to host address
