...
class UserSQL
{
	...
	{		
		return "INSERT INTO Users (user_id, google_id, email, image_url, password, first_name, last_name, birth_date, phone_number, last_login) VALUES ('$new_user_id', '$googleID', '$email', '$imageUrl', '$pass', '$firstname', '$lastname', '$bday', '$phoneNum', NOW())";
	...
	*/
	...
	public function search_users($searchValue)
	{
		
//		return "SELECT user_id, first_name, last_name FROM Users WHERE first_name LIKE '$searchValue' OR last_name LIKE '$searchValue' OR CONCAT(first_name, last_name) LIKE '$searchValue' Order by first_name";
		return "SELECT user_id, first_name, last_name FROM Users WHERE first_name LIKE '$searchValue' Order by first_name";
